...
> flasher can write?* It maps every Cyber Controller firmware profile to its gate-support status:
> what is **shipped + hardware-validated**, what is **architecturally supported but not yet
