...
Dead Man's Switch is an anti-forensic dead-man gate for ESP32 security firmware. It
**permanently and irrecoverably destroys data** on the device it runs on, by design. It is built for
...
- **T2 eFuse burns.** The T2 tier deliberately burns eFuses. This is permanent and documented.
